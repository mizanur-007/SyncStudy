...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-emerald-50 text-neutral-content">
        <aside>

          <p className='text-3xl font-bold'><img className="h-14 md:h-20 lg:h-24 -ml-8 md:-ml-0" src="/logo.png" alt="" /></p>
          <p className="ml-0 md:ml-12 text-black">Embracing the collaborative spirit of our group study</p>
        </aside> 
        <nav>
        ...
        <nav>
            <h1 className="text-xl font-medium text-black">Contact Us</h1>
            <p className="text-black">Phone: +88017000</p>
            <p  className="text-black">Email: mizanridoy007@gmail.com</p>
            <p  className="text-black">Road no-09, Kallyanpur</p>
